...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 9, fontWeight: '600', color: Colors.slate500, textTransform: 'uppercase', letterSpacing: 0.5 },
  hint: { fontSize: 8, color: Colors.slate400, marginLeft: 'auto' },
  ...
  recordInfo: { flex: 1 },
  recordText: { fontSize: 11, fontWeight: '500', color: Colors.slate700 },
  recordTextActive: { color: Colors.red },
  recordSub: { fontSize: 9, color: Colors.slate400, marginTop: 2 },
  ...
  timer: { fontSize: 10, fontWeight: '600', color: Colors.red },
  ...
  playDuration: { fontSize: 10, fontWeight: '600', color: Colors.slate600 },
  deleteBtn: { padding: 4 },
});
