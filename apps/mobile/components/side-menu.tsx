...
const styles = StyleSheet.create({
  ...
  logoText: { fontSize: 19, fontWeight: '800', color: Colors.slate900 },
  logoSub: { fontSize: 11, color: Colors.slate400, letterSpacing: 1, textTransform: 'uppercase' },
  ...
  menuLabel: { flex: 1, fontSize: 16, fontWeight: '500', color: Colors.slate700 },
  footer: { position: 'absolute', bottom: 40, left: 20 },
  footerText: { fontSize: 12, color: Colors.slate300 },
});
